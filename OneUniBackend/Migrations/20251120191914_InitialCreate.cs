        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    education_type = table.Column<int>(type: "education_type", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_active = table.Column<bool>(type: "boolean", nullable: true, defaultValue: true),
                    verification_status = table.Column<int>(type: "verification_status", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    gender = table.Column<int>(type: "gender_type", nullable: true),
                    id_document_type = table.Column<int>(type: "id_document_type", nullable: true),
                    ...
                    guardian_relation = table.Column<int>(type: "guardian_relation", nullable: true),
                    city = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    address = table.Column<string>(type: "text", nullable: true),
                    phone = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    profile_picture_url = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    test_type = table.Column<int>(type: "test_type", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    session_type = table.Column<int>(type: "session_type", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    application_status = table.Column<int>(type: "application_status", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "(now() AT TIME ZONE 'UTC'::text)"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "(now() AT TIME ZONE 'UTC'::text)"),
                    deleted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    document_type = table.Column<int>(type: "document_type", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "idx_applications_university_program",
                table: "applications",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_departments_university_id",
                table: "departments",
                column: "university_id");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_educational_records_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_mentorship_sessions_mentor_id",
                table: "mentorship_sessions",
                column: "mentor_id");

            migrationBuilder.CreateIndex(
                name: "idx_mentorship_sessions_student_id",
                table: "mentorship_sessions",
                column: "student_id");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_user_refresh_tokens_user_id",
