...
public partial class OneUniContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)   => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=oneuni;Username=postgres;Password=postgres");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Application>(entity =>
        {
            ...
            entity.HasOne(d => d.Programs).WithMany(p => p.Applications)
        ...
        modelBuilder.Entity<MeritFormula>(entity =>
        {
            ...
            entity.HasOne(d => d.Programs).WithMany(p => p.MeritFormulas)
                .HasForeignKey(d => d.ProgramId)
                .OnDelete(DeleteBehavior.SetNull)
